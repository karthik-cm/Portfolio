...
const AboutMe = () => {
	return (
		<div className="conatiner py-5" style={{width: "99%"}}>
			<div className="row">
				...
				<div className="col-lg-4 col-xm-8 profile-details-section">
					...
					<p className="about-me-description">
					   Hello everyone, I am currently pursuing Master's in Computer Science course at Santa Clara University (Mar 2021 - Mar 2023).
					   Previously I have worked as Full Stack Developer at Tata Consultancy Services for over 4 years. 
